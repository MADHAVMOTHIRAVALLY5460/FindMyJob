...
function CandidateCard({ applicant, remarks, isAnalyzing, onRunAnalysis, onView }) {
  return (
    <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-xs hover:border-zinc-300 transition-all">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-zinc-100">
        ...
        <div className="flex items-center gap-3 self-end sm:self-center">
          ...
          >
            <svg className={`w-3.5 h-3.5 ${isAnalyzing ? 'animate-spin text-orange-600' : 'text-zinc-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
