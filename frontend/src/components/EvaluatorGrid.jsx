...
function EvaluatorGrid({ remarks, compact = false }) {
  ...
  return (
    <div className={`grid ${compact ? 'grid-cols-1 md:grid-cols-2 gap-3' : 'grid-cols-1 gap-3.5'}`} role="list" aria-label="Evaluator agent verdicts">
        ...
        >
          <div className="flex items-center justify-between mb-1.5">
            <div className="flex items-center gap-2">
              <span className={`w-2 h-2 rounded-full ${agent.color}`} aria-hidden="true"></span>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${getVerdictBadgeClass(agent.data.verdict)}`}>
